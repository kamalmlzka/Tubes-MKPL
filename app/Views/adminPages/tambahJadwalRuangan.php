		...
		<main>
			<div class="container-form">
				<div class="body-container-form">
					<div class="head">
						<h3>Tambah Jadwal Ruangan KU-1-4</h3>
					...
					<form action="<?= base_url("tambahJadwalRuangan/save"); ?>" method="post">
						<input type="hidden" name="ruangan_id" value="<?= session()->get('ruangan_id'); ?>">
						<!-- Start first day -->
						...
						<div class="container-form-field">
							...
							<input type="type" name="6_7_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="6_7_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 07:30-08:30 Am</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="7_8_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="7_8_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 08:30-09:30 Am</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="8_9_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="8_9_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 09:30-10:30 Am</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="9_10_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="9_10_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 10:30-11:30 Am</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="10_11_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="10_11_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 11:30-12:30 Pm</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="11_12_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="11_12_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 12:30-13:30 Pm</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="12_13_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="12_13_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 13:30-14:30 Pm</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="13_14_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="13_14_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 14:30-15:30 Pm</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="14_15_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="14_15_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 16:30-17:30 Pm</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="16_17_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="16_17_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 17:30-18:30 Pm</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="17_18_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="17_18_dosen">
						</div>
						<div class="container-form-field">
							<span>Jam 18:30-19:30 Pm</span>
							<span>Nama Mata Kuliah :</span>
							<input type="type" name="18_19_mataKuliah">
							<span>Kode Dosen :</span>
							<input type="type" name="18_19_dosen">
						</div>
						<!-- End first day -->
