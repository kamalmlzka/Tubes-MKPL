		...
		<main>
			<div class="container-form">
				<div class="body-container-form">
					...
					<form action="<?= base_url("editRuangan/save"); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="container-form-field">
							...
							<span>No Kelas :</span>
							<input type="text" value="<?= session()->get('ruangan_no_ruangan'); ?>" name="no_kelas">
						</div>
						<div class="container-form-field">
							<span>Lokasi Kelas :</span>
							<input type="text" value="<?= session()->get('ruangan_lokasi_kelas'); ?>" name="lokasi_kelas">
						</div>
						<div class=" container-form-field">
							<span>Photo Kelas :</span>
							<input type="file" name="foto_kelas" accept="image/*">
						</div>
